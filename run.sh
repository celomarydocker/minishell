/bin/gcc PARSER/print/apply_flags.c PARSER/print/checker_flags.c PARSER/print/display.c\
	  ...
	  ERRORS/srcs/ft_pipe_errors.c ERRORS/srcs/additional_function_error.c EXECUTION/srcs/ft_sort_export.c EXECUTION/srcs/helper_function.c libft/*.c -o minishell -lcurses
./minishell
