#!/bin/bash
gcc -Wall -Werror -Wextra libft/*.c PARSER/print/apply_flags.c PARSER/print/checker_flags.c PARSER/print/display.c\
	  ...
	  ERRORS/srcs/ft_pipe_errors.c ERRORS/srcs/additional_function_error.c -o minishell
./minishell